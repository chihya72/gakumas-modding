...
选择本地构建生成的 0.4.8 插件 ZIP。公开仓库不直接提交包含配置档资产的发布包。
...
(学马游戏本体身体为单 t0,多材质合图通常不需要。)

## 当前版本

插件源码版本：0.4.8。

发布包用 `python tools/package_blender_addon.py -o dist/gakumas_mi-0.4.8.zip` 生成
