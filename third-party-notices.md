...
`3dmigoto-gkms/d3d11.dll` 是 GPL-3.0 项目 3DMigoto 的修改版二进制，其许可要求整体以
同一许可分发。
...
| 组件 | 位置 | 许可证 | 来源 |
|---|---|---|---|
| 3DMigoto v1.4.9（**修改版**） | `3dmigoto-gkms/d3d11.dll` | GPL-3.0 | <https://github.com/bo3b/3Dmigoto> |
| 3DMigoto ShaderFixes | `3dmigoto-gkms/ShaderFixes/` | GPL-3.0 | 同上 |
...
[`3dmigoto-gkms/FLIP-RESIZE-PATCH.md`](3dmigoto-gkms/FLIP-RESIZE-PATCH.md)，
...
发布用的 Inno Setup 安装包由
[`.github/workflows/release-3dmigoto-gkms.yml`](.github/workflows/release-3dmigoto-gkms.yml)
在 CI 上从上游 Release 下载后打入，本仓库不提交这两个文件：
