...
| 贴图 / 材质（t0 自动 DDS、分材质 t1/t4 烘焙、中性、COLOR/描边） | ~85% | t0/t1/t4 通道语义已实机实测；0.7.0 新增 t1 单通道输入与旧 profile ps-t2→ps-t4 防错。缺多套服装持续校准、PNG→DDS 多材质 selector。 |
...
- 材质属性：材质类型预设、`渲染材质`（不透明/透明）、明暗微调；`t4.A` 不暴露为作者选项，由材质类型预设固定。
