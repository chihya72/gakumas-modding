...
更新：2026-08-16 · Blender 插件 1.1.0
...
| 文档 | 管什么 |
|---|---|
| [`ab-target-rig-route-2026-08-17.md`](ab-target-rig-route-2026-08-17.md) | **做什么、按什么顺序做**：target-rig 架构、数据契约（五档处理）、P0–P8、10 条硬闸门、物理硬规矩、落实顺序 |
...
| [`known-risks.md`](known-risks.md) | **本仓制作工具已知风险与排查索引**：导入、烘焙、导出或打包异常先查这里 |
| [`lessons-learned.md`](lessons-learned.md) | **反面教训汇总**：已排除的路线、作废的做法、被推翻的结论 |
| [`current-status-and-roadmap.md`](current-status-and-roadmap.md) | 远端已发布版本的能力、边界和维护事项 |
