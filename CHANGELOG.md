...
> 冻结期的 RC 闭环之后，骨骼映射表单、承重关节闸门、三步 UI、校色 t0、装饰策略和新骨链
> 已全部转为实机实证，逐项见 `research/current-status-and-roadmap.md`。）
>
...
[环境准备与安装 1.1「网盘素材包」](docs/wiki/1-环境准备与安装.md)。只换装不重导 JSON 的话
